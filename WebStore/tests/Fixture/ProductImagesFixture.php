...
class ProductImagesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_indexes' => [
            'product_id_index' => ['type' => 'index', 'columns' => ['product_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'CST_product_images_id' => ['type' => 'foreign', 'columns' => ['product_id'], 'references' => ['product', 'id'], 'update' => 'cascade', 'delete' => 'cascade', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
