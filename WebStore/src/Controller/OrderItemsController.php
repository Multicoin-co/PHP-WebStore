...
class OrderItemsController extends AppController
{
    ...
    public function add()
    {
        ...
        $product = $this->OrderItems->Product->find('list', ['limit' => 200]);
        $order = $this->OrderItems->Order->find('list', ['limit' => 200]);
        $this->set(compact('orderItem', 'product', 'order'));
        $this->set('_serialize', ['orderItem']);
    }
